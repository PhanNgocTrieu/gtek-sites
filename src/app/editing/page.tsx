    ...
    <main>
      <Section className="py-14 bg-slate-50 dark:bg-slate-900">
        <div className="max-w-4xl">
          ...
          <h1 className="mt-4 text-4xl md:text-5xl font-extrabold tracking-tight text-gtek-navy dark:text-slate-200">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3">
            ...
            <Link
              href="/projects"
              className="inline-flex items-center justify-center rounded-md border border-slate-300 bg-white px-6 py-3 text-base font-bold text-slate-900 hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:hover:bg-slate-800"
            >
              View Projects page
            </Link>
          </div>
      ...
      <Section className="py-14 bg-white dark:bg-slate-950">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          <div className="lg:col-span-7 space-y-6">
            <Card className="p-6">
              <h2 className="text-xl font-bold text-slate-900 dark:text-slate-200">1) Add a project (no code)</h2>
              <ol className="mt-4 space-y-3 text-sm text-slate-700 list-decimal pl-5 dark:text-slate-400">
                <li>
                  ...
                  <Link href="/studio" className="font-semibold text-gtek-navy hover:underline dark:text-slate-300">
                    /studio
                  </Link>
                  .
                </li>
                ...
                <li>
                  Refresh{" "}
                  <Link href="/projects" className="font-semibold text-gtek-navy hover:underline dark:text-slate-300">
                    Projects
                  </Link>{" "}
          ...
          <div className="lg:col-span-5 space-y-6">
            <Card className="p-6">
              <h2 className="text-xl font-bold text-slate-900 dark:text-slate-200">Non-tech friendly by design</h2>
            ...
            <Card className="p-6">
              <h2 className="text-xl font-bold text-slate-900 dark:text-slate-200">Need access?</h2>
